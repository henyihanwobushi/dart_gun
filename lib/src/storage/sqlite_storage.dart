...
class SQLiteStorage implements StorageAdapter {
    ...
    try {
      ...
      _db = await openDatabase(
        ...
        onCreate: (db, version) async {
          ...
          await db.execute('CREATE INDEX idx_updated_at ON $_tableName (updated_at)');
        },
      );
  ...
  Future<Map<String, dynamic>> getStats() async {
    ...
    final countResult = await _db!.rawQuery('SELECT COUNT(*) as count FROM $_tableName');
  ...
  void _ensureInitialized() {
    if (!_initialized || _db == null) {
      throw StateError('SQLiteStorage not initialized. Call initialize() first.');
    }
  }
